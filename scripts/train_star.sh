...
# cmd: bash scripts/train_star.sh  star_key1 star  1  local pretrained_path=/home/wupf/singularity/pt/singularity_temporal_17m.pth
...
output_dir=${exp_dir}/mc_${dataset}/${dataset}_${exp_name}
